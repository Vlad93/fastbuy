...
const videos = () => {
  ...
  .pipe(gulpif(isDevFlag, dest('dev/videos')))
  .pipe(gulpif(!isDevFlag, dest('dist/videos')))
}
...
const dev =  parallel(resourcesJs, resourcesCss, resourcesFiles, videos, fonts, htmlMinify, scripts, styles, svgSprites, imagesDev, webpConv);
